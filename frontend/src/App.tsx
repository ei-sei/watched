...
import { PWA_REFRESH_KEY } from '@/api/client'
...
function AuthProvider({ children }: { children: ReactNode }) {
  ...
  const login = async (username: string, password: string) => {
    ...
    // Always persist the refresh token in localStorage as a fallback for when
    // the HttpOnly cookie is cleared by the browser (e.g. Android backgrounding).
